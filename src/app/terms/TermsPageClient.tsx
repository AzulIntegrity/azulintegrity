...
import type { TermsPageData, FooterData } from "@/lib/types";
...
export default function TermsPageClient({ termsData, footerData }: TermsPageClientProps) {
      ...
      <main className={styles.main}>
        ...
        <section className={styles.pageHeader}>
          <div className={styles.headerContent}>
            <h1>{termsData.header.title}</h1>
            <p>{termsData.header.subtitle}</p>
          </div>
        </section>
        ...
        <section className={styles.termsContent}>
          <div className={styles.termsContainer}>
            ...
            <div className={styles.termsEffectiveDate}>
              <p><strong>Effective Date: {termsData.meta.effective_date}</strong></p>
            </div>
            ...
            {termsData.sections.map((section, index) => (
              <div key={index} className={styles.termsSection}>
                ...
                {/* Special handling for Contact Information section (section 21) */}
                {section.heading.includes('Contact Information') && (
